...
function setup(){
    ...
    particle7 =Bodies.circle(238,10,10,particle_options);
    World.add(world,particle7);
    particle8 =Bodies.circle(240,10,10,particle_options);
    World.add(world,particle8);
    particle9 =Bodies.circle(244,10,10,particle_options);
    World.add(world,particle9);
    particle10 =Bodies.circle(247,10,10,particle_options);
...
function draw(){
  ...
  ellipse(particle6.position.x,particle5.position.y,10);
  ellipse(particle7.position.x,particle5.position.y,10);
  ellipse(particle8.position.x,particle5.position.y,10);
  ellipse(particle9.position.x,particle5.position.y,10);
